...
<span style="color:black">Desejamos estudar características de uma popução por meio de um modelo probabilístico $F(\pmb\theta)$, em que $\pmb\theta$ é um vetor de quantidade fixas e desconhecida que denominamos de **parâmetros**.</span>  </br></br>
